root=../results/FuseRoad_CULane_b5/FuseRoad
...
out0=${root}/${exp}_out0_normal.txt
out1=${root}/${exp}_out1_crowd.txt
out2=${root}/${exp}_out2_hlight.txt
out3=${root}/${exp}_out3_shadow.txt
out4=${root}/${exp}_out4_noline.txt
out5=${root}/${exp}_out5_arrow.txt
out6=${root}/${exp}_out6_curve.txt
out7=${root}/${exp}_out7_cross.txt
out8=${root}/${exp}_out8_night.txt
...
cat ${root}/${exp}_out*.txt>${root}/${exp}_iou${iou}_split.txt
