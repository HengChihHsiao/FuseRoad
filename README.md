...
```
conda env create --name FuseRoad --file environment.txt python=3.11
```
...
## Evaluation
Download the pretrained model from [GoogleDrive](https://drive.google.com/drive/folders/1e35oSeIUSWnr4MvrlIP853U91qCwbnLp?usp=drive_link) as put it to models/py_utils/SegFormer/imagenet_pretrained directory.

### Example
```
python test.py CONFIG_FILE_NAME --model_name FuseRoad --modality eval --split testing --testiter ITER_NUM
```
...
## License
LSTR is released under BSD 3-Clause License.
